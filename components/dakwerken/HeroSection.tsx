        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <a
                href="#contact"
                className="relative flex items-center justify-center gap-2 bg-red-600 hover:bg-red-500 text-white text-base font-extrabold px-6 py-4 rounded-xl transition-all shadow-lg shadow-red-900/50"
              >
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Gratis offerte aanvragen
                <span className="absolute -top-2 -right-2 bg-yellow-400 text-yellow-900 text-[10px] font-black px-1.5 py-0.5 rounded-full uppercase tracking-wide leading-none">Snel!</span>
              </a>
              <a
                href="tel:0703456789"
                className="flex items-center justify-center gap-2 bg-transparent hover:bg-white/10 border-2 border-white/40 hover:border-white text-white text-base font-bold px-6 py-4 rounded-xl transition-all"
              >
